...
small_buttons = {
    ...
    "희망 진로": "전자공학관련 분야 전부에 흥미가 있어, 전자공학과 관련된 직종을 선택하고 싶습니다.",
    "좋아하는 것": "여행, 독서, 코딩을 좋아합니다.",
    "싫어하는 것": "게으름, 미루는 습관을 싫어합니다.",
    "자기 소개": "안녕하세요 저는 서산중앙고등학교에 재학 중인 3학년 5반 임태욱입니다.",
    "진로 준비": "진로를 위해 다양한 코딩 심화 프로젝트 및 캠프, 피지컬 컴퓨팅, 독서 등을 하고 있습니다.",
    "취미 활동": "저는 축구와 배드민턴을 좋아하고 음악을 듣는 것 또한 좋아합니다.",
    "성공 사례": "작년 학술제에서 빛 제어 코드를 통해 리스를 통제하여 큰 호응을 받았던 기억이 있습니다."
}
